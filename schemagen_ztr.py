...
parser.add_argument("DDL", help = "The destination for the SQL DDL file (default schema_ztr_ddl.gen.sql)",
                            nargs = "?", default = "schema_ztr_ddl.gen.sql", type=argparse.FileType("w"))
parser.add_argument("CONS", help = "The destination for the SQL constraints & indexes file (default schema_ztr_cons.gen.sql)",
                            nargs = "?", default = "schema_ztr_cons.gen.sql", type=argparse.FileType("w"))
